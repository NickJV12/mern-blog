      ...
      <div className='w-full max-w-7xl mx-auto'>
        <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
          ...
          sm:text-xl font-semibold dark:text-white'>
            ...
            via-purple-500 to-pink-500 rounded-lg text-white'>Case</span>
            Blog
        </Link>
          </div>
          <div className='grid grid-cols-2 gap-8  mt-4 sm:grid-cols-3 sm:gap-6'>
            ...
            <Footer.LinkGroup col>
              <Footer.Link 
              href='https://www.github.com/Priyalsingh1211'
              target='_blank'
              rel='noopener noreferrer'>
                GitHub
              </Footer.Link>
              <Footer.Link 
              href='https://www.instagram.com/priyal_singh03/'
              target='_blank'
              rel='noopener noreferrer'>
                Instagram
              </Footer.Link>
        ...
        <div className='w-full sm:flex sm:items-centre sm:justify-between'>
          <Footer.Copyright href='#' by='Case Blog' year={new Date().getFullYear()}/>
